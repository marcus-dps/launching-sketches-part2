    ...
    <div className="App">
      <Routes>
        ...
        <Route
          path="/intro-2"
          element={
            <Screen image="/Input.jpg" back="/intro-1">
              <Button to="/" x="35" y="420" w="150" h="55" />
              <Button to="/intro-3" x="195" y="420" w="150" h="55" />
            </Screen>
          }
        />
        <Route
          path="/intro-3"
          element={
            <Screen image="/Dropdown.jpg" back="/intro-2">
